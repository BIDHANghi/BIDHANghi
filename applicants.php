...
// echo "</pre>";
// echo $_GET['name'];
$sql = "SELECT * from applications a Inner Join customers c on a.cus_id = c.id INNER JOIN internships i ON a.int_id = i.id WHERE a.applied = 1 AND i.category = '$category' AND i.nameOfCompany = '$name'";
$result = $db->query($sql);
