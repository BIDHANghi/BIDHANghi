...
$sql = "SELECT * FROM applications a INNER JOIN customers c ON a.cus_id = c.id INNER JOIN internships i ON a.int_id = i.id WHERE a.cus_id = '$cus_id' and a.int_id = '$int_id'";
...
foreach($application as $application){
    ...
    $company = $application['nameOfCompany'];
